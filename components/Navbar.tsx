                    ...
                    <div className="pt-2 pb-3 space-y-1 px-4">
                        ...
                        {!isAuthenticated ? (
                            ...
                            <>
                                ...
                                <button
                                    onClick={() => signOut({ callbackUrl: '/' })}
                                    className="w-full text-left block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-indigo-50"
                                >
                                    <div className="flex items-center">
                                        <LogOut className="h-4 w-4 mr-2" />
                                        Sign out
                    ...
                    {!isAuthenticated && (
                        <div className="pt-4 pb-3 border-t border-gray-200 px-4">
                            <div className="mt-3 space-y-3">
                                <Link
                                    href="/signin"
                                    className="block px-4 py-2 rounded-md text-base font-medium text-indigo-600 border border-indigo-600 hover:bg-indigo-50 text-center"
                                    onClick={toggleMenu}
                                >
                                    Sign in
                                </Link>
                                <Link
                                    href="/signup"
                                    className="block px-4 py-2 rounded-md text-base font-medium bg-indigo-600 text-white hover:bg-indigo-700 text-center"
                                    onClick={toggleMenu}
                                >
                                    Sign up
                                </Link>
